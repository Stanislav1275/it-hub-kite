...
const variants = cva('', {
    variants: {
        ...
        size: {
            ...
            lg: 'h-auto w-auto  max-w-[200px] rounded-lg',
        },
    },
...
export const UserAvatar = (props: UserAvatarPropsType) => {
    ...
    const validatePath = !avatar?.startsWith('data') || false;
    const url = validatePath ? 'http://localhost:3001/avatars/user-[1].png' : avatar;
    return (
